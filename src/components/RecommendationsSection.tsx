...
const RecommendationsSection = () => {
  return (
    <section id="recommendations" className="py-[120px] px-4 bg-section-deep">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {recommendations.map((rec, i) => (
            <motion.div
              ...
              className="relative rounded-xl p-8 border-l-4 border-l-primary group hover:-translate-y-1 transition-all duration-300 bg-section-alt hover:shadow-[0_8px_30px_hsl(var(--primary)/0.15)]"
            >
              {/* Decorative quote mark */}
              <span className="absolute top-4 right-5 text-[6rem] font-heading leading-none pointer-events-none select-none transition-opacity duration-300 group-hover:opacity-[0.2] text-primary/10">
                "
              </span>
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span className="inline-block px-3 py-1 rounded-full text-[0.75rem] font-heading text-accent-foreground bg-accent">
                    {rec.org}
                  </span>
                  {rec.linkedIn && (
                    <a
                      ...
                      className="w-7 h-7 rounded-full flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground transition-colors duration-200"
                ...
                <span className="inline-block mt-5 px-3 py-1.5 rounded-full text-[0.75rem] font-heading text-primary border border-primary/40 bg-section-deep">
                  {rec.context}
                </span>
                ...
                {rec.socialProof && (
                  <motion.div
                    initial={{ borderColor: "hsl(var(--primary) / 0.3)" }}
                    whileInView={{ borderColor: ["hsl(var(--primary) / 0.3)", "hsl(var(--primary) / 0.8)", "hsl(var(--primary) / 0.3)"] }}
                    viewport={{ once: true }}
                    transition={{ duration: 1.5, delay: 0.5 }}
                    className="mt-4 rounded-lg p-2.5 px-3.5 border-l-2 bg-section-deep"
                  >
        ...
        <div className="text-center mt-12">
          ...
          <a
            href="#contact"
            className="inline-block px-6 py-2.5 rounded-full text-[0.85rem] font-heading font-semibold text-primary border border-primary hover:bg-primary hover:text-primary-foreground transition-colors duration-200"
          >
            Request References →
          </a>
        </div>
